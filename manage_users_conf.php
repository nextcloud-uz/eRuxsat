      ...
      exit();
        ...
        if ($row = mysqli_fetch_assoc($resultl)) {
            ...
            if ($row['add_card'] == 0) {
                ...
                if (!empty($Uname) && !empty($Number) && !empty($Email)) {
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                        ...
                        if (!$row = mysqli_fetch_assoc($resultl)) {
                            ...
                            echo "Ushbu serial raqam bazada mavjud!";
                            exit();
                        }
                    }
                }
                ...
                echo "Ushbu foydalanuvchi bazada mavjud";
                exit();
            }    
        }
        else {
            echo "Biror karta tanlanmadi!";
            exit();
        }
    }
}
    ...
    if (!mysqli_stmt_prepare($result, $sql)) {
      ...
      exit();
        ...
        if ($row = mysqli_fetch_assoc($resultl)) {
            ...
            if ($row['add_card'] == 0) {
                echo "Birinchi foydalanuvchi qo`shishingiz kerak!";
                exit();
            }
            else{
                if (empty($Uname) && empty($Number) && empty($Email)) {
            ...
            echo "Tahrirlash uchun foydalanuvchi tanlangani yo`q!";
            exit();
        }
    }
}
...
if (isset($_POST['delete'])) {
    ...
    if (empty($user_id)) {
        echo "O`chirish uchun foydalanuvchi tanlanmadi";
        exit();
    } else {
